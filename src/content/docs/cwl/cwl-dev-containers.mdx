...
Here we introduce Dev Containers and how to use them for data analysis with CWL.
...
The Common Workflow Language (CWL) is introduced [here](/nfdi4plants.knowledgebase/cwl/cwl-introduction/)
...
The YAML file for this tutorial looks like this: 
...
Now you have everything you need to run a CWL workflow within a Docker container. Just open your WSL (or terminal, if you're using Linux) and run the following command:
